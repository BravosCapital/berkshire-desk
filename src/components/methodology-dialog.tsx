    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent>
        ...
        <div className="space-y-5 overflow-y-auto px-6 py-5 text-sm leading-relaxed text-muted">
          ...
          <section>
            <h3 className="mb-1 font-medium text-fg">Analyst tools</h3>
            <p>
              Overview also shows implied operating multiple, look-through earnings, cash-deployment
              sliders (buybacks vs equities) and an earnings × multiple sensitivity grid. None of
              these change the published two-column IV; they are scenario helpers.
            </p>
          </section>
          <p>
